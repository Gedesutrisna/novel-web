    ...
    <section class="container mx-md-5">
        ...
        <div class="comment text-white my-3">
            ...
            <div class="comments d-flex align-items-center">
                ...
                @if ($review->dislikeLikeReviews)
                @foreach ($review->dislikeLikeReviews as $dislikeLikeReview)
                ...
                <form action="/addLike" method="post">
                    ...
                    <button type="submit" class="btn-dl">
                        <i class='bx bx-like'>{{ $dislikeLikeReview->sum('like') }}</i>
                    </button>
                </form>
                <form action="/addDislike" method="post">
                    ...
                    <button type="submit" class="btn-dl">
                        <i class='bx bx-dislike'>{{ $dislikeLikeReview->sum('dislike') }}</i>
                </button>
                </form>
                @endforeach
